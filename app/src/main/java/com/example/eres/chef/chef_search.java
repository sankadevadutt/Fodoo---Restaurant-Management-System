...
public class chef_search extends Fragment implements AdapterView.OnItemSelectedListener{
    RecyclerView recyclerView;
    private List<chefhelper> updatefoodList;
    private chefsearchAdapter adapter;
                ...
                }else if(!dishn.contains(usersearch.getEditText().getText().toString()))
                {
                    ...
                    dataa.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            adapter = new chefsearchAdapter(getContext(),updatefoodList,phone);
